...
groups.ready = function () {
    ...
    handler = {
        ...
        find: function (offset) {
            ...
            $.ajax({
                url: app + '/api/groups/from/' + offset,
                type: 'GET',
        ...
        searchByName: function (offset, q) {
            ...
            $.ajax({
                url: app + '/api/search/groups/from/' + offset + '?q=' + q,
                type: 'GET',
        ...
        searchByNameCount: function (q) {
            $.ajax({
                url: app + '/api/search/groups/count?q=' + q,
                type: 'GET',
                timeout: 9000, // 9 seconds
        ...
        refreshData: function (json, q) {
            ...
            if (data.length == 0) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    row +=
                        ...
                        '  <div class="group ui checkbox">' +
                        '    <input type="checkbox" id="' + data[i].groupId + '">' +
                        '    <label for="' + data[i].groupId + '">' + data[i].groupName + '</label>' +
                        '  </div>' +
                        '</td>'
                    ;
                    ...
                    var viewUrl = app + '/groups/' + data[i].groupId;
                    row +=
            ...
            $checkboxes = $('.group.checkbox'); // fix bugs
            $checkboxes
                .checkbox({
