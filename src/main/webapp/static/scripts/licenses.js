...
licenses.ready = function () {

    // selectors

    var
        $checkboxes = $('.license.checkbox'),
    ...
    handler = {
        ...
        find: function (offset) {
            ...
            $.ajax({
                url: app + '/api/licenses/from/' + offset,
                type: 'GET',
        ...
        searchByName: function (offset, q) {
            ...
            $.ajax({
                url: app + '/api/search/licenses/from/' + offset + '?q=' + q,
                type: 'GET',
        ...
        searchByNameCount: function (q) {
            $.ajax({
                url: app + '/api/search/licenses/count?q=' + q,
                type: 'GET',
                timeout: 9000, // 9 seconds
        ...
        refreshData: function (json, q) {
            ...
            $checkboxes = $('.license.checkbox'); // fix bugs
            $checkboxes
                .checkbox({
        ...
        delete: function () {
            ...
            $.ajax({
                ...
                data: JSON.stringify(licenseIds),
                timeout: 9000, // 9 seconds
